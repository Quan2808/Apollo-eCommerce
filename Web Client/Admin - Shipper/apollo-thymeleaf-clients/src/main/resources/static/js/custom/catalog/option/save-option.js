document.addEventListener("DOMContentLoaded", function () {
    const form = document.getElementById("kt_ecommerce_add_option_form");
    const submitButton = document.getElementById("kt_ecommerce_add_option_submit");
    ...
    form.addEventListener("submit", function (e) {
        ...
        if (productName.trim() === "") {
            showErrorAlert("Option Name is required.");
            resetSubmitButton();
            return;
        }
